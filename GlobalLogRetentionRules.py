...
def lambda_function():
    return add_resource(Function(
        ...
        MemorySize=128,
        Timeout=60,
        Code=Code(ZipFile=Sub(read_local_file("GlobalLogRetentionRules_Lambda.py")))
    ))
...
def sceptre_handler(sceptre_user_data):
    ...
    scheduling_rule(sceptre_user_data.get('schedule', 'rate(1 day)'), sceptre_user_data['rules'])
